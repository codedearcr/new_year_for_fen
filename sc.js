...
function redirectToAnotherFile() {
    window.location.href = 'another-file.html'; // Thay bằng đường dẫn tệp HTML khác
}

window.onload = function() {
    setTimeout(showButton, 10000); // Hiện nút sau 10 giây
};
...
setTimeout(function() {
  window.location.href = "5.html"; // Đường dẫn tới tệp HTML khác
}, 18000); // 18 giây (18000 milliseconds)    
window.onload = function() {
  init();
};